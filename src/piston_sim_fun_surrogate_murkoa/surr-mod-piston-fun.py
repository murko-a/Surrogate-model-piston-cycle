...
# from compare_true_pred import compare_true_pred
...
class SurrogateModel():
	...
	def predict_fun(self, *mdls, predict_dt):
		return predict(self, *mdls, predict_data = predict_dt)
		
	def performance_fun(self, *mdls_pf, predict_dt = None, plot_pf = None):
		performance(self, *mdls_pf, predict_data = predict_dt, plot_perf = plot_pf)

	def compare_true_pred_fun(self, *mdls_pf, plot_typ = None, dfe = False):
		return compare_true_pred(self, *mdls_pf, plot_type = plot_typ, df = dfe)
