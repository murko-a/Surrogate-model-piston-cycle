...
def plot_lolipop(self, od_acc, od_mae, od_mse, od_rmse, od_r2, od_time):
    ...
    ax2.hlines(y=data_range, xmin=0, xmax=list(od_mae['mean(MAE)']), color='blue', zorder=0)
    ...
    ax3.hlines(y=data_range, xmin=0, xmax=list(od_mse['mean(MSE)']), color='blue', zorder=0)
    ...
    ax4.hlines(y=data_range, xmin=0, xmax=list(od_rmse['mean(RMSE)']), color='blue', zorder=0)
    ...
    ax5.hlines(y=data_range, xmin=0, xmax=list(od_r2['mean(R2)']), color='blue', zorder=0)
    ...
    ax6.hlines(y=data_range, xmin=0, xmax=list(od_time['time']), color='blue', zorder=0)
