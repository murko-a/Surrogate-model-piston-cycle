...
def plot_lolipop(self, od_acc, od_mae, od_mse, od_rmse, od_r2, od_time):
    ...
    ax[0][2].set_title("Mean Square Error")
    ax[0][2].set_xlabel("mean(MSE)")
    ...
    ax[1][1].set_title("R2 value")
    ax[1][1].set_xlabel("mean(R2)")
    ...
    ax[1][2].set_title("Time of prediction")
